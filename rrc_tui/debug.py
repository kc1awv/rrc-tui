...
WELCOME_BODY_KEYS = {
    ...
    B_WELCOME_LIMITS: "HUB_LIMITS",
}

HUB_LIMITS_KEYS = {
    L_MAX_NICK_BYTES: "MAX_NICK_BYTES",
    L_MAX_ROOM_NAME_BYTES: "MAX_ROOM_NAME_BYTES",
    L_MAX_MSG_BODY_BYTES: "MAX_MSG_BODY_BYTES",
    L_MAX_ROOMS_PER_SESSION: "MAX_ROOMS_PER_SESSION",
    L_RATE_LIMIT_MSGS_PER_MINUTE: "RATE_LIMIT_MSGS_PER_MINUTE",
}
